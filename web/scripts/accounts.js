...
(function(cloudStack) {
                    ...
                    detailView: {
                        ...
                        actions: {
                            ...
                            resourceStructure: {
                            	label : '查看资源关系',
                                action: {
                                    custom: cloudStack.uiCustom.resourceStructure({

                                        listView: {
                                            listView: {
                                            	firstClick : false,
                                                id: 'resourceStructures',
                                                ...
                                                dataProvider: function(args) {
                                                    ...
                                                    $.ajax({
                                                        url: createURL('getResource'),
                                                        data: data,
                                                        success: function(json) {
                                                            var items = json.listresponse.resourcestructurevoobj;
                                                            args.response.success({
                                                                data: items
                                                            });
                                                        }
    ...
    var accountActionfilter = function(args) {
        ...
        allowedActions.push("resourceStructure");
