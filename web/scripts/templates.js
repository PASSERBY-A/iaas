            ...
            templates: {
                ...
                listView: {
                    ...
                    fields: {
                        ...
                        accountManage:{
                        	label : 'label.template.account.manage',
                    ...
                    appendFields:{
                    	accountManage1:{
                        	label : 'label.templateAccount.manage'
                        	//select :function(){alert("select");},
                        	//action:function(args){alert(args)
                        	//console.info(args);}
                        }
                    },
                    ...
                    /*added by Li Manxin */
//cloudStack.sections.templates.accounts
                    appendView:{

                        name: 'Template Account',
                        isMaximized: true,
                        viewAll: {
                            path: 'templates.templateAccount',
                            label: 'label.users'
                        }
                    },
            ...
            templateAccount:{
            //label.templateAccount.manage
            	type: 'select',
                id: 'templateAccount',
                title: 'label.templateAccount.manage',
                noSelect : true,
               // custom :true,
                listView: {
                	filters: false,
                	advSearchFields : false,
                    id: 'templateAccount',
                    fields: {
					
                    	accountName: {
                            label: 'label.templateAccount.accountName'
                        },
						password:{
							label :'label.templateAccount.password'
						},
						accountType: {
                            label: 'label.templateAccount.accountType'
                            ,converter: function(args) {
                                    return cloudStack.converters.convertTemplateAccountTypeStr(args);
                            }
                        }
                    },
                            ...
                            createForm: {
                                ...
                                fields: {
                                    ...
                                    password: {
                                       ...
                                       // isPassword: true,
                                        id: 'password',
                                        docID: 'helpTemplateAccountPassword'
                                    },
                                    accounttype: {
                                        label: 'label.templateAccount.accountType',
                                        docID: 'helpTemplateAccountType',
                                        validation: {
                                            required: true
                                        },
                                        select: function(args) {
                    ...
                    dataProvider: function(args) {
                        ...
                        /*if ("domains" in args.context) {
						 ...
						 $.extend(data, {
                                templateId: args.ref.id,//TODO
                                cmsz:"yes"
                        });
						//added by Li Manxin 
						window.currentTemplateId = data.templateId;
                        $.ajax({
                            url: createURL('getTemplateAccount'),
                            data: data,
                            async: true,
                            success: function(json) {
                                //var items = json.listaccountsresponse.account;
                            	var items = json.root;
                            //	window.currentTemplateId = args.ref.id;
                                args.response.success({
                                    //actionFilter: accountActionfilter,
                                    data: items
                                });
                    ...
                    detailView: {
                        ...
                        actions: {							
                            remove: {
                                ...
                                action: function(args) {
                                    var data = {
                                        id: args.context.templateAccount[0].id,
                                        cmsz: 'yes'
                                    };
                                    $.ajax({
                                        url: createURL('deleteTemplateAccount'),
                                        data: data,
                                        async: true,
                                        success: function(json) {
                    ...
                    detailView: {
                        ...
                        actions: {
                            ...
                            copyISO: {
                                ...
                                action: function(args) {
                                	if(typeof(args.context.isos[0].zoneid)=="undefined"){
                                		alert('该iso模板无区域id，复制失败');
                                		return; 
                                	}
                                    $.ajax({
