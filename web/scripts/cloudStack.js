        ...
        sectionPreFilter: function(args) {
            ...
            if (isAdmin()) {
            	sections = ["dashboard", "instanceMenu","instances","hpux","resourceMenu", "system", "storage", "network", "templates", "property", "equipmentEnroll",
            	            ...
            	            "logMenu", "events", "logs", "workOrders","test","configuration", "statisticMenu", "resourceStatistics", "workOrderReport", "topData"];
    ...
    $(window).bind('cloudStack.pluginReady', function() {
        ...
        var loginArgs = {
           ...
           */
                ...
                var userValid = false;
                //alert("listCapabilities="+createURL("listCapabilities"));
                $.ajax({
