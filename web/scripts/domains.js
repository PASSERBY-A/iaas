...
(function(cloudStack) {
                  ...
                  domainObj["volumeTotal"] = total;
                    ...
                    stats: {
                                ...
                                action: function(args) {
                                	...
                                	$.ajax({
                                        ...
                                        success: function(data) {
                                        	if(data.status==1){
                                        		cloudStack.dialog.window({message:"该域已经提交工单，且处于待审批中，无法重现提交新工单"},function(){
                                        			cloudStack.dialog.hide();
                                        			//$(".resources form input[type='submit']").remove();
                                        			return;
                                           	});
                                        	}else if(data.status==2){
                                        		cloudStack.dialog.window({message:"该域已经提交工单，且审批通过，等待处理中"},function(){
                                        			cloudStack.dialog.hide();
                                        			return;
                                           	});
                                        	}else if(data.status==4){
                                        		cloudStack.dialog.window({message:"该域已经提交工单，且正在处理中"},function(){
                                        			cloudStack.dialog.hide();
                                        			return;
                                           	});
                                        	}else{
                        ...
                        dataProvider: function(args) {
                                ...
                                success: function(json) {
                                    ...
                                    if (limits != null) {
                                        for (var i = 0; i < limits.length; i++) {
                                             ...
                                             */
                                                case "0":
                                                    domainObj["instance"] = limit.max;
                                                    break;
                                                case "1":
                                                    domainObj["ip"] = limit.max;
                                                    break;
                                                case "2":
                                                    domainObj["volume"] = limit.max;
                                                    break;
                                                case "3":
                                                    domainObj["snapshot"] = limit.max;
                                                    break;
                                                case "4":
                                                    domainObj["template"] = limit.max;
                                                    break;
                                                    /**
                                                     * added by steven
                                                     */
                                                case "6":
                                                    domainObj["network"] = limit.max;
                                                    break;
                                                case "7":
                                                    domainObj["vpc"] = limit.max;
                                                    break;
                                                case "8":
                                                    domainObj["cpu"] = limit.max;
                                                    break;
                                                case "9":
                                                    domainObj["memory"] = limit.max;
                                                    break;
                                                case "10":
                                                    domainObj["primaryStorage"] = limit.max;
                                                    break;
                                                case "11":
                                                    domainObj["secondaryStorage"] = limit.max;
                                                    break;
                                            }
                                        }
                                    }
                            ...
                            args.response.success({
                                data: domainObj,
                                actionFilter: applyActionfilter
                            });
                        }
                    }
                }
    ...
    var applyActionfilter = function(args) {
        var allowedActions = [];
            allowedActions.push("edit"); //merge updateResourceLimit into edit
        return allowedActions;
    }
