...
import com.cmsz.cloudplatform.model.request.Request;
import com.cmsz.cloudplatform.model.response.Response;
import com.cmsz.cloudplatform.utils.RequestWrapper;
import com.cmsz.cloudplatform.utils.ResponseSerializer;
...
public abstract class BaseAction extends ActionSupport implements SessionAware, ServletRequestAware, ActiveUserAware, RequestParamsAware {
	...
	protected com.cmsz.cloudplatform.model.response.Response transformResponse(Object responseData, String responseType, int responseHTTPCode){
		com.cmsz.cloudplatform.model.response.Response result = new com.cmsz.cloudplatform.model.response.Response();
		Map m = new HashMap();
