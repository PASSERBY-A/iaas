...
import com.cmsz.cloudplatform.spi.plugin.xml.wrapper.CPU;
import com.cmsz.cloudplatform.spi.plugin.xml.wrapper.HostBaseInfo;
import com.cmsz.cloudplatform.spi.plugin.xml.wrapper.Memory;

@XmlRootElement(name="Info")
@XmlAccessorType(XmlAccessType.FIELD)
public class HPHostWraper {
